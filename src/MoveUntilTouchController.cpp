...
//=============================================================================
bool MoveUntilTouchController::init(
    hardware_interface::RobotHW* robot, ros::NodeHandle& nh)
{
  ...
  try
  {
    ...
    ROS_INFO_STREAM(
        "Reading force/torque data from '" << ft_wrench_name << "'.");
  }
  catch (const hardware_interface::HardwareInterfaceException& e)
  {
    ROS_ERROR_STREAM(
        "Unable to get 'ForceTorqueSensorHandle' for '" << ft_wrench_name
                                                        << "'.");
    return false;
  }
  ...
  {
    ROS_ERROR_STREAM(
        "Unable to get 'TriggerHandle' for '" << ft_tare_name << "'.");
    return false;
  }
  ...
  mFTThresholdActionServer.reset(
      new actionlib::ActionServer<SetFTThresholdAction>{
          ...
          std::bind(
              &MoveUntilTouchController::setForceTorqueThreshold,
              this,
              std::placeholders::_1),
          false});
...
//=============================================================================
void MoveUntilTouchController::update(
...
//=============================================================================
bool MoveUntilTouchController::shouldAcceptRequests()
{
  return isRunning();
}
...
PLUGINLIB_EXPORT_CLASS(
    rewd_controllers::MoveUntilTouchController,
