#ifndef REWD_CONTROLLERS_JOINTCOMMANDCONTROLLER_HPP_
#define REWD_CONTROLLERS_JOINTCOMMANDCONTROLLER_HPP_
...
class JointGroupCommandController final
...
public:
  JointGroupCommandController();
  virtual ~JointGroupCommandController();
...
protected:
  /** \brief The JointGroupCommandControllerBase should accept new commands
...
#endif // REWD_CONTROLLERS_JOINTCOMMANDCONTROLLER_HPP_
